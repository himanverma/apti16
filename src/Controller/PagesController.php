...
class PagesController extends AppController
{
    ...
    public function home(){
        ...
        $klasses = $klTbl->find()->contain(['Chapters','Chapters.Subjects'])->all();
        $subjects = $sbTbl->find()->contain(['Chapters','Chapters.Subjects'])->all();
        
        $this->set('subjects',$subjects);
        $this->set('klasses', $klasses);
